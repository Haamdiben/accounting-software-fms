...
namespace WindowsFormsApplication3
{
    public partial class Ajoutfacture4 : Form
    {
        ...
        private void Ajoutfacture4_Load(object sender, EventArgs e)
        {
            ...
            if (reste >= 0)
            {
               // if ( (reste <= float.Parse(maxc)) || (0 == float.Parse(maxc)) ) //somethin going wrong here so i've just add the test line if (1==1)
                ...
                else
                {
                    ...
                    if (MessageBox.Show("Le réste dépasse le maximum crédit de se client, voulez vous continuez?",
                    "Important Question",MessageBoxButtons.YesNo)==DialogResult.Yes)
                    {
                        string ConString = "datasource=localhost;port=3306;username=root";
