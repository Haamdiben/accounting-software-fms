...
{
    public partial class Adddec : Form
    {
        public Adddec(string l11, string l12, string l13, string ch3, string ch4, string ch5, string ch6, string ch7, string ch8, string ch9, string ch10, string ch11)
        {
            InitializeComponent();
            textBox4.Text = l11;
            textBox8.Text =l12;
            dateTimePicker2.Text = l13;
            dd2 = ch3;
            dd3 = ch4;
            dd4 = ch5;
            dd5 = ch6;
        ...
        string dd2, dd3, dd4, dd5, dd6, dd7, dd8, dd9, dd10;
        ...
        private void Adddec_Load(object sender, EventArgs e)
        {
            if (dd2 != null)
            {
