...
{
    public partial class Ajoutdevis2 : Form
    {
        public Ajoutdevis2(string ch0, string ch1, string ch2, string ch3, string ch4, string ch5, string ch6, string d1, string d2, string d3, string d4, string d5, string d6, string d7, string d8, string d9, string d10, string ch8, string ch9, string ch110, string ch10, string ch11, string mc)
        {
        ...
        private void Ajoutdevis2_Load(object sender, EventArgs e)
        {
