...
namespace WindowsFormsApplication3
{
    public partial class Ajoutfacture : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Veuillez selectionez un client.",
                "Erreur",
            ...
            Ajoutfacture2 af2 = new Ajoutfacture2(idselect, label10.Text, dateTimePicker1.Text, comboBox1.Text, textBox1.Text, textBox2.Text, textBox3.Text, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, textBox5.Text, textBox6.Text, textBox7.Text, comboBox2.Text, richTextBox1.Text,maxc);
            af2.ShowDialog();
